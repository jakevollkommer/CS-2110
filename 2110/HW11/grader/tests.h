...
#define M_FREELIST_POINTS   4
#define M_FREELIST2_POINTS  4
#define M_FREELIST3_POINTS  4
#define M_EXACT_FIT_POINTS  4
#define M_NEXT_FIT_POINTS   4
#define MALLOC_ZERO         3
#define MALLOC_EDGE_MAX     3
#define MALLOC_EDGE_MAX1    3
#define MALLOC_EDGE_HUGE    3
#define MALLOC_OOM          3
#define MALLOC_STRESS       6
